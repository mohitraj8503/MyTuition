 ...
 */
export const onUserLogin = functions.region("asia-south1").https.onCall(async (data, context) => {
 ...
 */
export const getHomeData = functions.region("asia-south1").https.onCall(async (data, context) => {
 ...
 */
export const getClassDetail = functions.region("asia-south1").https.onCall(async (data, context) => {
 ...
 */
export const getHomeworkList = functions.region("asia-south1").https.onCall(async (data, context) => {
 ...
 */
export const markHomeworkComplete = functions.region("asia-south1").https.onCall(async (data, context) => {
  const homeworkId = data?.homeworkId;
  if (!homeworkId) throw new functions.https.HttpsError("invalid-argument", "homeworkId required");
 ...
 */
export const getSubjects = functions.region("asia-south1").https.onCall(async (data, context) => {
 ...
 */
export const getCalendarData = functions.region("asia-south1").https.onCall(async (data, context) => {
 ...
 */
export const getProfileData = functions.region("asia-south1").https.onCall(async (data, context) => {
  const uid = context.auth?.uid || "stu_789";
 ...
 */
export const sendNotification = functions.region("asia-south1").https.onCall(async (data, context) => {
